...
<body>
    ...
    <?php include_once('notes-slidebar.php'); ?>
    

    <main style="margin-left: 15%;width: 85%">
        <!-- Courses area start -->
        <div class="courses-area section-padding40 fix">
            <div class="container">
                ...
                <div class="row" id="notesContainer" style="display:none;">
                    ...
                    $sql = "SELECT tblnotes.*,tbluser.* from tblnotes join tbluser on tblnotes.UserID=tbluser.ID WHERE tblnotes.Category = 'M.tech' LIMIT $offset, $no_of_records_per_page";
