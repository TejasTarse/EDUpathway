                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <a href="../index.php" class="text-secondary">Home Page!!</a>
                        </div>
                        <div class="d-flex align-items-center justify-content-between mb-4">
                           
                            <a href="signin.php" class="text-secondary">Already Registered !!</a>
                        </div>

                        <button type="submit" class="btn btn-secondary py-3 w-100 mb-4" name="submit">Sign Up</button>
