        ...
        <div class="courses-area section-padding40 fix">
            <div class="container">
                ...
                <div class="row" id="notesContainer" style="display:none;">
                    ...
                    $sql = "SELECT tblnotes.*,tbluser.* from tblnotes join tbluser on tblnotes.UserID=tbluser.ID WHERE tblnotes.Category = 'M.com' LIMIT $offset, $no_of_records_per_page";
