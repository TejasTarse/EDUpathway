      ...
      <div class="container-fluid">
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-lg-3 col-md-4 col-8">
            <div class="logo">
              <a href="index.php">
                <h3 class="logo-text">EDUpathway</h3>
              </a>
            </div>
          </div>
          <!-- Navigation -->
          <div class="col-lg-9 col-md-8 col-4 text-end">
            <nav class="main-nav d-none d-lg-block">
              <ul id="navigation" class="nav-list">
                ...
                <li><a href="user/signup.php" class="btn nav-btn ">Join</a></li>
                <li><a href="user/signin.php" class="btn nav-btn">Log in</a></li>
              </ul>
            </nav>
            <!-- Mobile toggle -->
